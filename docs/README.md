...
- [`expansion_board/`](<hardware-platforms/expansion_board/>): Contains the schematics of the PMDB16 expansion board, as well as the datasheets and user manuals for the components used in the board.
